...
This project was carried out in the course "Artificial Intelligence", which is a required core course of the 3rd year of the Department of Computer Science in AUEB. You can find the full repository [here](https://github.com/EleniKechrioti/Imdb-classification-ML).
