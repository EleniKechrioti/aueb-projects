...
def stars_horizontal(n):
    ...
    *****
    ...
    if n == 1:
        ...
        return stars_horizontal(n-1) + '*'   # mporeite na xrhsimopoihsete perissoteres 'h ligoteres grammes
    return sum_sequence( n , stars_horizontal(n))
...
def askisi6():
    ...
    for r in range(1,6):
        print('Emvado kyklou aktinas', r, '=', pi*r*r)
