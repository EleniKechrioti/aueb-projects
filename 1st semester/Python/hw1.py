...
def parrot():
    ...
    print('- "' + input( 0 * str(print ('- "' + input(0 * str(print ('- "' + input(0 * str(print('- "' + input() + '"'))) + '"'))) + '"'))) + '"')
...
def fix_me():
    ...
    def per_tr(pl):
         return 2*pl + (2*pl**2)**0.5
    
    def per_k(r):
          return 2*r*pi
    
    
    print('Emvado kyklou aktinas', 1, '=', emv_kykloy(1),
          'me perifereia =', per_k(1))
    print('Emvado kyklou aktinas', 2, '=', emv_kykloy(2),
          'me perifereia =', per_k(2))
    print('Emvado isoskelous or8ogwniou trigwnou me ka8eti pleura', 1,
          '=', emv_tr(1),
