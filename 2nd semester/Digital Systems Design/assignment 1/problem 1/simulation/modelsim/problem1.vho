...
SIGNAL \I3|out1~0_combout\ : std_logic;
...
\I3|out1~0\ : maxv_lcell
-- Equation(s):
-- \I3|out1~0_combout\ = (\x2~combout\ & (((\x4~combout\)))) # (!\x2~combout\ & (!\x5~combout\ & ((!\x4~combout\) # (!\x1~combout\))))
